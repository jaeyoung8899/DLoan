 ...
 * desc : 비밀번호 변경
 * auth : shon
 * libPasswordChange.js
 */

var libPasswordChange = {
	init : function () {
		this.events();
	},
	...
	events : function () {
		...
		$("#btnNext").on('click', function (event) {
			libPasswordChange.passwordChange('next');
		});
		
		// 비밀번호 변경
		$("#btnChange").on('click', function (event) {
			libPasswordChange.passwordChange('change');
		});
	},
	...
	passwordChange : function(flag) {
		...
		var option = {
			url      :  _ctx + '/lib/passwordChangeProc',
