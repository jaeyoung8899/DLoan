...
<body>
	...
	<div class="content">
		<section class="content_main" style="width: 90%">
			...
			<div class="result_list">
					...
					<table class="result_table" id="requestInfo" style="width:1550px;">
						...
						<thead>
							<tr>
								...
								<th><a href="javascript:;" onclick="comm.sort.sortOrder(this, storeRequest.search);" data-sort="LOAN_WAIT_DATE">구입<br>만기일</a></th>
								<th><a href="javascript:;" onclick="comm.sort.sortOrder(this, storeRequest.search);" data-sort="RETURN_DATE">반환일</a></th>
								...
								<th><a href="javascript:;" onclick="comm.sort.sortOrder(this, storeRequest.search);" data-sort="USER_NAME">구입자명</a></th>
				...
				<div class="btn_wrap_ab">
					...
					<input type="button" class="btn_sms" id="btnReqStatus4" value="구입대기">
					<input type="button" class="btn_refuse" id="btnLoanWait" value="구입대기연장">
				</div>
				<div class="btn_extra">
					<!-- 2020/04/06 AGK 추가 -->
	...
	<div class="back_black" id="loanWaitLayer" style="display:none">
		<div class="approver_popup_wrap" style="width:400px; height:150px; margin-top:400px">
			<form class="" name="loanWaitForm" id="loanWaitForm">
				<div class="popup_form_01" style="width:313px">
					<label class="up" for="enterPlanDate" style="margin-right:5px">입고예정일 향후</label>
