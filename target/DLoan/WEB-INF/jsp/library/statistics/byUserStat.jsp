...
<body>
	...
	<div class="content">
		<section class="content_main">
			...
			<section class="setting_cont">
				<form class="form-horizontal" name="userStatForm" id="userStatForm">
					...
					<tr>
						<th>번호</th>
						<th><a href="javascript:;" onclick="byUserStat.sortOrder(this, 'NAME');" data-sort="NAME">이용자명</a></th>
						<th><a href="javascript:;" onclick="byUserStat.sortOrder(this, 'COUNT');"  data-sort="COUNT">Total</a></th>
							...
							<c:when test="${fn:length(resultList) > 0}">
								...
								<c:forEach var="row" items="${resultList}" varStatus="status">
									<tr>
										...
										<td>${row.name}</td>
										<td>${row.count}</td>
										<td style="text-align:left; line-height:150%; padding:5px 0px;">${row.title}</td>
									</tr>
	...
	<script type="text/javascript" src="<c:url value="/resources/library/js/statistics/byUserStat.js?v=${version }" />"></script>
</body>
</html>