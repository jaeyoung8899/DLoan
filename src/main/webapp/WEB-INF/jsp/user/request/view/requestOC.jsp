...
<div id="wrap">
	...
	<div id="body_contents">
		...
		<ul class="tab_wrap" id="reqHeader">
			<%
				String referer = request.getHeader("REFERER");
				String version = request.getParameter("version");
			%>

			<a href="${ctx}/request<c:if test="${version ne null and version ne ''}">?version=${version }</c:if>" class="on"><li>희망도서 서비스 신청</li></a>

			<%if (SessionUtils.getUserId() != null ) { %>
			<a href="${ctx}/myRequestInfo" class="myRequestInfo"><li>신청현황</li></a>
			<%} %>
		</ul>
		...
		<ul class="info_list">
			...
			<li>당해연도 기준으로 출판년도가 5년 이상 경과한 도서</li>
		...
		<div class="search_form_01">
			<form name="requestForm" id="requestForm">
				<fieldset>
					...
					<input type="hidden" id="reqType" name="reqType" value="bookstore"/>
