...
<%--			<input type="button" class="btn_top_cs" value="매뉴얼" onclick="window.open('https://library.cheongju.go.kr:7180//resources/store/책값 반환제 서점v1.pptx', '_blank')"/>--%>
			<input type="button" class="btn_top_cs" value="원격지원" onclick="window.open('http://113366.com/kait', '_blank')"/>
		</div>
		<div class="header_main_wrap">
			<div class="header_main">
				<h1 class="h1_logo"> 
					<a href="${ctx }/store/storeRequestInfo"><img src= "<c:url value="/resources/store/images/logo-bookstore-return.png" />" alt="메인로고"></a>
				</h1> 
				<ul class="menu_nav">
					...
					<li><a class="menu_tab021<c:if test="${requestScope['javax.servlet.forward.request_uri'] eq '/store/returnLoanInfo'      }">_on</c:if>" href="${ctx }/store/returnLoanInfo">구입반환</a></li>
