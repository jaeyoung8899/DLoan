...
var byUserStat = {
	...
	viewSearch : function(){
		...
		var form = new commSubmit('userStatForm');
		form.setUrl( _ctx + "/lib/statistics/byUserStatInfo");
		form.submit();
		comm.loading.show();
	},
	...
	excelDownload : function() {
		...
		if(confirm("엑셀파일을 다운로드 하시겠습니까?")) {
			var form = new commSubmit('userStatForm');
			form.setUrl(_ctx + "/lib/statistics/userStatInfoToExcel");
			form.submit();
			comm.loading.show();
		}
	},
